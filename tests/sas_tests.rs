...
#[test]
fn generate_readonly_sas_url_test() {
  use url::Url;

  let uri_str = generate_readonly_sas_url(
    "meecodevstorage0",
    FAKE_STORAGE_ACCESS_KEY,
    "dev",
    "w1n3aw3em0x5d5c8xfoteql17e1w",
  ...
  let expected_uri = Url::parse(
    "https://meecodevstorage0.blob.core.windows.net/dev/w1n3aw3em0x5d5c8xfoteql17e1w?sp=r&se=2023-01-17T11%3A59%3A39Z&sv=2018-11-09&sr=b&sig=1chUrj3Cd%2BOPH2YcBy4gRg7659BhoKrDAWZw4505GKQ%3D&rscd=attachment%3B%20filename%3D%22foo.jpg%22%3B%20filename%2A%3DUTF-8%27%27foo.jpg"
  ).unwrap();
